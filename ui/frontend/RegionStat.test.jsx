...
import { RegionStat, computeRegionContourStyle } from './RegionStat'
...
describe('RegionStat Component', () => {
  it('renders region tooltip when service returns data', async () => {
...
describe('RegionStat Styling', () => {
  it('choose color from feature', () => {
   
    const st = computeRegionContourStyle({ type: 'Feature', geometry: null, properties: { avgprice: 2500} })
  ...
  it('choose min color from feature', () => {
    ...
    const st = computeRegionContourStyle({ type: 'Feature', geometry: null, properties: { avgprice: 10} })
  ...
  it('choose max color from feature', () => {
    ...
    const st = computeRegionContourStyle({ type: 'Feature', geometry: null, properties: { avgprice: 3100} })
  ...
  it('choose default color if feature not defined', () => {
    ...
    const st = computeRegionContourStyle()
